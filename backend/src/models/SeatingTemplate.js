...
const seatingTemplateSchema = new mongoose.Schema(
  {
...
seatingTemplateSchema.index({ ownerRole: 1, name: 1 });

export default mongoose.model("SeatingTemplate", seatingTemplateSchema);
